---
name: ship
description: 'After every milestone issue has a commit on the PR branch: "ship the milestone", "merge the PR", "close out the milestone", or `/ship`. Squash-merges, closes the milestone, writes a transition entry.'
user-invocable: true
---
